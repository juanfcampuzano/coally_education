...
class SoftSkillsRagOutputModel(BaseModel):
    soft_skills_courses: List[CourseModel]

class SoftSkillsRagAgent(BaseRagAgent):
    def __init__(self):
        template = """
        Con la siguiente información:
        - HABILIDADES BLANDAS QUE LE FALTAN A LA PERSONA: {topics}
        ...
        Tu tarea es extraer cursos en español online para cada una de estas habilidades blandas. Solo puedes agregar habilidades que estén dentro
        ...
        """
        super().__init__(template=template, response_format=SoftSkillsRagOutputModel)